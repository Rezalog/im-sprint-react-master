...
*/
const PART4_3 = `INSERT INTO user(name, email) VALUES('setName','setEmail'); `;
...
*/
const PART4_10 = `INSERT INTO content(title, body, created_at, userId) 
                  VALUES('testtitle', 'testbody', NOW(), 1)`;
